# -*- coding: utf-8 -*-
"""
Created on Thu Sep 15 15:29:05 2022
...
frompath = 'J:\\TESSDATAType\\ROT\\'
temp = []
pathdelete = 'J:\\TESSDATAType\\deletefileROT\\'
NUMCOUNT = 0
for root, dirs, files in os.walk(frompath):
   for file in files:
       ...
       if (strfile[-5:] == '.fits'):
           ...
           while True:
               inputcode = input('d is delete, b is break, L is back : ')
               ...
               if inputcode == 'l':
                  shutil.move(pathdelete+temp[-1], frompath) 
